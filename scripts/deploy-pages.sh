...
git add .
git commit -m "Deploy @fiduswriter/document-template-editor to Forgejo Pages"
...
cd "$ROOT"
rm -rf "$BUILD_DIR"
echo "Done. Available at https://fiduswriter.pages.fiduswriter.org/fiduswriter-document-template-editor-ts/"
